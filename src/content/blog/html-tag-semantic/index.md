...
| `<h1>,<h2>,<h3>,<h4>,<h5>,<h6>` | 标题元素实现了六层文档标题，`<h1>` 是最大的标题，`<h6>` 是最小的标题。标题元素简要|地描述章节的主题。 |
...
```html
<header>页面头部，通常包含 logo、页面标题和导航性的目录。
    <div>MDN标题</div>
    <nav>导航
        <ul>列表
            <li></li>
...
<main>主内容：整个页面核心内容
    ...
    <div>
        ...
        <div class="content">核心内容
            <article>content</article>
            <div>一个独立于content的section：metadata 修改时间
                <section></section>
            </div>
        </div>
    </div>
