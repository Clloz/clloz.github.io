...
多数开源软件会推出两个 `RC` 版本，最后的RC2则成为正式版本。闭源软件较少公开使用，微软公司在 `Windows 7` 上应用此名称。苹果公司把在这阶段的产品称为 `Golden Master Candidate`（简称`GM Candidate`），而最后的 `GM` 即成为正式版本。
