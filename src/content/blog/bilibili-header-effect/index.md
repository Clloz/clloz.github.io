...
由于眨眼的帧之间的间隔和两次眨眼之间的间隔是不同的，我们需要嵌套定时器。外部的就是控制多久眨眼一次，内部的就是眨眼的几个帧的切换。对于定时器的嵌套中的一些细节可以看我的另一篇文章：[定时器的一些思考](https://www.clloz.com/programming/front-end/js/2020/07/16/settimeout/ "定时器的一些思考")。最后的代码大致如下：
