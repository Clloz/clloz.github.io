...
import { Aside, MdxRepl, TabItem, Tabs } from 'astro-pure-clloz/user'
...
<MdxRepl>
import { Card } from 'astro-pure-clloz/user'
...
<MdxRepl>
import { Collapse } from 'astro-pure-clloz/user'
...
<Fragment slot='desc'>
  ```jsx
  import { Tabs, TabItem } from 'astro-pure-clloz/user';
...
<Fragment slot='desc'>
  ````jsx
  import { MdxRepl } from 'astro-pure-clloz/user'
...
<MdxRepl width='80%'>
import { CardList } from 'astro-pure-clloz/user'
...
<MdxRepl>
import { Timeline } from 'astro-pure-clloz/user'
...
<MdxRepl width='80%'>
<div>
import { Steps } from 'astro-pure-clloz/user'
...
<MdxRepl>
import { Spoiler } from 'astro-pure-clloz/user'
...
<MdxRepl>
import { FormattedDate } from 'astro-pure-clloz/user'
...
<MdxRepl>
import { Label } from 'astro-pure-clloz/user'
...
<MdxRepl>
import { Svg } from 'astro-pure-clloz/user'
...
<MdxRepl width='100%'>
<div>
import { Icon } from 'astro-pure-clloz/user'

Single use: <Icon name='rss' class='inline' />

Preview all icons available (click button to copy):

import { Icons as allIcons } from 'astro-pure-clloz/libs'
