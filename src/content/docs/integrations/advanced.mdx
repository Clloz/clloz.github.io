...
<MdxRepl>
import { Quote } from 'astro-pure-clloz/advanced'
...
<MdxRepl width='80%'>
import { GithubCard } from 'astro-pure-clloz/advanced'
...
<MdxRepl width='80%'>
import { LinkPreview } from 'astro-pure-clloz/advanced'
...
<MdxRepl>
import { QRCode } from 'astro-pure-clloz/advanced'
