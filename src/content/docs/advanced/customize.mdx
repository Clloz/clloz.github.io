...
import { Aside, Spoiler, Steps } from 'astro-pure-clloz/user'
...
6. Use as component library for other Astro projects (yes, this project can be broken down into the UI component library): [Package details](https://www.npmjs.com/package/astro-pure-clloz).
...
1. Search the `Footer` in your project code:
   ...
   ---
   import { Footer, Header, ThemeProvider } from 'astro-pure-clloz/components/basic'
   import type { SiteMeta } from 'astro-pure-clloz/types'
...
4. Solve the sub-dependencies problem:
   ...
   import { Icon } from 'astro-pure-clloz/user' // [!code ++]
...
5. Change the reference in `BaseLayout.astro`:
   ...
   import {
     ...
     ThemeProvider,
     ThemeProvider
   } from 'astro-pure-clloz/components/basic'
   // [!code --]
